...
<a href="http://badge.fury.io/js/onvif"><img src="https://badge.fury.io/js/onvif.png" alt="NPM version"></a></p>
<p>ONVIF Client protocol Profile S Node.js implementation.</p>
<p>This is a wrapper to ONVIF protocol which allows you to get information about your NVT (network video transmitter)
device, its media sources, control PTZ (pan-tilt-zoom) movements and manage presets.</p>
...
<h2>Installation</h2><p><code>npm install onvif</code></p>
<h2>Tests</h2><p>In the library directory run <code>npm test</code></p>
<h2>Documentation</h2><p>To build jsdoc for the library with default theme run <code>npm run jsdoc</code>. Otherwise use <code>jsdoc</code> with sources from
<code>./lib/*.js</code></p>
...
});</code></pre><h2>Troubleshooting</h2><p>Different cameras have different ONVIF implementation. I've tested this module only with a couple of devices. So if you got different problems with this library, please let me know via e-mail. Else please just send the model of your
camera to me.</p>
<h1>API</h1><p>Documentation generated by jsdoc can be found here: http://agsh.github.io/onvif/</p>
...
Discovery is a EventEmitter inheritor, so you can wait until discovery timeout, or subscribe on <code>device</code> event.
...
<h4>Technical description</h4><p>When the cam object creates it automatically sends three command to the ONVIF device:
<code>getCapabilities</code>, <code>getVideoSources</code> and <code>getProfiles</code>. After that it fills correspondent properties of an object:</p>
<ul>
<li>capabilities<ul>
<li>device</li>
<li>events</li>
...
<li>http://www.onvif.org/Portals/0/documents/WhitePapers/ONVIF_WG-APG-Application_Programmer's_Guide.pdf</li>
</ul></article>
    </section>
